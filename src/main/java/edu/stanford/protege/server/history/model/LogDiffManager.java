...
import static edu.stanford.protege.server.history.model.LogDiffEvent.COMMIT_OCCURRED;
...
public class LogDiffManager implements Disposable {
    ...
    /**
     * Get instance of a history object factory
     *
     * @return Diff factory
     */
